...
export default function DropDownProfile() {
    ...
    const handleLogout = () => {
        ...
        toast(
            <div className="flex flex-col items-center p-2  bg-background-surface_default rounded-lg">
                <span className="text-text-primary font-medium">Bạn có chắc muốn đăng xuất?</span>
    ...
    return (
        <div className="flex flex-col gap-4 dropDownProfile bg-background-neutral-subtle">
            <div className="flex justify-start items-center gap-2 hover:bg-background-surface_default cursor-pointer">
                <FaUser />
                <h1 className="text-base font-medium text-text-primary">Thông tin cá nhân</h1>
            </div>
            <div
                className="flex justify-start items-center gap-2 hover:bg-background-surface_default cursor-pointer text-text-negative"
            ...
            {loading && (
                <div className="fixed flex flex-col inset-0 bg-background-neutral-default bg-opacity-50 z-[100] items-center justify-center">
                    ...
                    <h1 className="text-lg font-medium text-text-white">Đang đăng xuất</h1>
                </div>
            )}
            <ToastContainer />
        </div>
