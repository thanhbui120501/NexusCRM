          ...
          >
            <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
              <div className="sm:flex sm:items-start">
                <div className="mx-auto flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-full bg-red-100 sm:mx-0 sm:h-10 sm:w-10">
                  <ExclamationTriangleIcon aria-hidden="true" className={`h-6 w-6 ${color}`} />
                </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              <button
                ...
                className={`inline-flex w-full justify-center rounded-md ${bgColor}  px-3 py-2 text-sm font-semibold text-white shadow-sm ${hoverColor}  sm:ml-3 sm:w-auto`}
              >
                Đóng
              </button>
              {/* <button
